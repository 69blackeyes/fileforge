...
export function PdfToJpg() {
  ...
  const handleFiles = useCallback(async (files: File[]) => {
    ...
    try {
      ...
      setError('Could not read PDF. It may be corrupted or password-protected.');
    }
  }, []);
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      setError('Something went wrong while converting this PDF. Please try another file.');
    } finally {
      setProcessing(false);
    }
  };
  ...
  const handleDownloadAll = async () => {
    ...
    for (let i = 0; i < resultUrls.length; i++) {
      ...
      zip.file(`page-${selectedPages[i]}.jpg`, blob);
    }
  ...
  return (
    <>
      <SEO
        ...
        description="Convert PDF pages to JPG images online for free. Select pages or convert all. Browser-based processing."
        path="/pdf-to-jpg"
      />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white">PDF to JPG</h1>
          <p className="mt-2 text-gray-600 dark:text-gray-400">Convert PDF pages to JPG images</p>
        ...
        {!file ? (
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            {processing && <ProcessingState message="Converting PDF to JPG..." />}
            ...
            {resultUrls.length > 0 && (
              <div className="card p-6 animate-slide-up">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <DownloadButton onDownload={handleDownloadAll} label={resultUrls.length === 1 ? 'Download JPG' : 'Download All as ZIP'} />
